...
Once a user has successfully registered an account with their email address / Google Oauth and logged in, they can see their existing tasks, create new tasks, update existing tasks, favorite and delete tasks.
